...
<head>
   ...
   <style>
     ...
     .search-btn, .search-btnRT, .search-btnHotel{
         left:25%
     }
 }
  @media (max-width:450px){
   ...
   <div class="main_search">
       ...
       <div class="parent">
           ...
           " onclick="changeTabUI(this); openCard();">
                           <img src="http://localhost/travel/wp-content/uploads/2024/10/tab-icon-flight.png" alt="tab-icon-flight" width="32" height="32" class="" style="
               display: block;
             ...
             color: #999999;
           " onclick="changeTabUI(this); openCard();">
                           <img src="http://localhost/travel/wp-content/uploads/2024/10/tab-icon-hotel.png" alt="tab-icon-hotel" width="32" height="32" class="" style="
               display: block;
               filter: brightness(50%) contrast(100%) grayscale(1);
               margin: 0 auto 9px;
               opacity: 0.6;
             ...
             color: #999999;
           " onclick="changeTabUI(this); openCard();">
                           <img src="http://localhost/travel/wp-content/uploads/2024/10/tab-icon-car.png" alt="tab-icon-car" id="carLogo" width="32" height="32" class="" style="
               display: block;
               filter: brightness(50%) contrast(100%) grayscale(1);
               margin: 0 auto 9px;
               opacity: 0.6;
             ...
             " onclick="RoundTrip(this)">
               ...
               <div class="ow-sec fields" id="owSec">
                   <div class="field-wrapper">
                       ...
                       <input style="padding-left: 30px;" class="inp-field" type="text" id="fromFlightOW"
                   ...
                   <div class="field-wrapper">
                       <div class="field-logo"><i class="fas fa-plane"></i></div>
                       <input style="padding-left: 30px;" class="inp-field" type="text" id="toFlightOW" onfocus="changeBorderColorFocus(this)"
                   ...
                   <div class="field-wrapper">
                       ...
                       <div class="date-picker-container">
                           <input style="padding-left:30px;" id="datepicker" class="date-input inp-field-date" placeholder=""
               ...
               <div class="rt-sec" id="rtSec">
                   <div class="field-wrapper">
                       <div class="field-logo"><i class="fas fa-plane"></i></div>
                       <input style="padding-left: 30px;" class="inp-field" type="text" placeholder="From..." id="fromFlightRT"
                           onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)" />
                       <div class="placeholder placeholder_border">From</div>
                   ...
                   <div class="field-wrapper">
                       <div class="field-logo"><i class="fas fa-plane"></i></div>
                       <input style="padding-left: 30px;" class="inp-field" type="text" id="toFlightRT" onfocus="changeBorderColorFocus(this)"
                           onblur="changeBorderColorBlur(this)" />
                       <div class="placeholder placeholder_border">To</div>
                   ...
                   <div class="field-wrapper">
                     ...
                     <div class="placeholder placeholder_border">Depature Date</div> -->
                       ...
                       <div class="date-picker-container">
                           <input style="padding-left:30px;" id="depDateFRT" class="date-input inp-field-date" placeholder=""
                               onblur="changeBorderColorBlur(this)" onclick="toggleCalendar(this)" />
                           <div class="placeholder placeholder_border">Depature Date</div>
                           <div class="calendar-popup">
                               <div class="calendar-header">
                   ...
                   <div class="field-wrapper">
                       <div class="field-logo"><i class="fas fa-calendar"></i></div>
                       <!-- <input class="inp-field" type="text" placeholder="Departure Date" /> -->
                       <!-- <input style="padding-left: 30px;" id="retDate" class="inp-field-date" type="date" placeholder=" " 
                         onblur="changeBorderColorBlur(this)" />
                     <div class="placeholder placeholder_border">Return Date</div> -->

                       <div class="date-picker-container">
                           <input style="padding-left:30px;" id="retDateFRT" class="date-input inp-field-date" placeholder=""
                               onblur="changeBorderColorBlur(this)" onclick="toggleCalendar(this)" />
                           <div class="placeholder placeholder_border">Return Date</div>
                           <div class="calendar-popup">
                               <div class="calendar-header">
                   ...
                   <div class="field-wrapper">
                       ...
                       <!-- <input class="inp-field" type="text" placeholder=" "
                         onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)" /> -->
                       <select class="inp-field" id="returnTimeSelectFRT" style="padding-left: 30px;">
                           <option value="null" selected>Any Time </option> <!-- Hidden placeholder -->
           ...
           <div class="card hotel-card" id="hotel-card">
               <div class="hotel-fields">
                   <div class="field-wrapper">
                       ...
                       <input style="padding-left: 30px;" class="inp-field" type="text" id="locHotel"
                           onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)" />
                 ...
                 <div class="placeholder placeholder_border">Check In</div> -->
                       ...
                       <div class="date-picker-container">
                           <input style="padding-left:30px;" id="checkin" class="date-input inp-field-date" placeholder=""
                               onblur="changeBorderColorBlur(this)" onclick="toggleCalendar(this)" />
                           <div class="placeholder placeholder_border">Check In</div>
                           <div class="calendar-popup">
                               <div class="calendar-header">
                 ...
                 <div class="placeholder placeholder_border">Check Out</div> -->
                       ...
                       <div class="date-picker-container">
                           <input style="padding-left:30px;" id="checkout" class="date-input inp-field-date" placeholder=""
                               onblur="changeBorderColorBlur(this)" onclick="toggleCalendar(this)" />
                           <div class="placeholder placeholder_border">Check Out</div>
                           <div class="calendar-popup">
                               <div class="calendar-header">
               ...
               <div class="car-feilds" id="car-fields">
                   <div class="first-row">
                       <div class="field-wrapper" style="padding-left: 33px;padding-right: 33px;">
                           ...
                           <input style="padding-left: 40px;background-color: yellow;" class="inp-field" type="text" id='fromCar'
                               onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)" />
                           <div class="placeholder placeholder_border" style="left: 5.5rem;">Location</div>
                   ...
                   <div class="second-row">
                       <div class="field-wrapper forty">
                           <div class="field-logo"><i class="fas fa-calendar"></i></div>
                           <div class="date-picker-container">
                               <input style="padding-left:30px;" id="depDateCar" class="date-input inp-field-date"
                                   onblur="changeBorderColorBlur(this)" onclick="toggleCalendar(this)" />
                               <div class="placeholder placeholder_border">Depature Date</div>
                               <div class="calendar-popup">
                                   <div class="calendar-header">
                       ...
                       <div class="field-wrapper twenty">
                           ...
                           <select class="inp-field" id="checkoutCar" style="width: 99%;" onblur="changeBorderColorBlur(this)">
                               <option value="null"></option> <!-- Hidden placeholder -->
                               <option value="0000">12:00 am</option>
                       ...
                       <div class="field-wrapper twenty">
                           ...
                           <div class="date-picker-container">
                               <input style="padding-left:30px;" id="retDateCar" class="date-input inp-field-date" placeholder=""
                                   onblur="changeBorderColorBlur(this)" onclick="toggleCalendar(this)" />
                               <div class="placeholder placeholder_border">Return Date</div>
                               <div class="calendar-popup">
                                   <div class="calendar-header">
                       ...
                       <div class="field-wrapper twenty">
                           ...
                           <select class="inp-field" id="retTimeCar" style="width:99%;" onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)">
                               <option value="null"></option> <!-- Hidden placeholder -->
                               <option value="0000">12:00 am</option>
                                <option value="0030">12:30 am</option>
                                <option value="0100">1:00 am</option>
                   ...
                   <div class="third-row" id="thirdRow" style="display: none; margin: 0.5rem 0 0 0;">
                       <div class="field-wrapper forty">
                           <select class="inp-field" id="discType" onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)">
    
                               <option value="Corporate">Corporate</option>
                               <option value="professional">Professional</option>
                           </select>
                           <div class="placeholder placeholder_border" style="left: 1rem;">Disocunt Type</div>
                           </select>
                       </div>
                       <div class="field-wrapper thirty">
                           <select class="inp-field" id="discCompany" onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)">
                               <option value="Hertz">Hertz</option>
                           </select>
                           <div class="placeholder placeholder_border" style="left: 1rem;">Discount Company</div>
                       </div>
                       <div class="field-wrapper thirty">
                           <input id="discCode" class="inp-field-date" type="text"
                               onfocus="changeBorderColorFocus(this)" onblur="changeBorderColorBlur(this)" />
...
`;
   ...
   <script>
       ...
       //     const roomSection = element.closest(".roomSec");

       //     // Check if roomSection exists before removing it
       ...
       //         reorderRoomNumbers()
       //     } else {
       //         console.error("Room section not found for the clicked element.");
       //     }
       // }

       // function reorderRoomNumbers() { console.log(8)
       //     const roomSections = document.querySelectorAll(".roomSec");
       //     console.log(roomSections)
       //     roomSections.forEach((section, index) => {
       //         const roomNumber = index + 1; // Update room number based on new order
       //         section.id = `roomSec${roomNumber}`;
       //         const sec=section.querySelector(".room-title")
       //         section.querySelector(".room-title").textContent = `Room ${roomNumber}`;
       //         console.log(roomNumber, sec)
       //         // Update IDs of elements within each room section
       //         section.querySelector(".fa-times").setAttribute("onclick", "removeRoom(this)");
       //         section.querySelector(`[id^="minusAdultRoom"]`).id = `minusAdultRoom${roomNumber}`;
       //         section.querySelector(`[id^="adultRoom"]`).id = `adultRoom${roomNumber}`;
       //         section.querySelector(`[id^="plusAdultRoom"]`).id = `plusAdultRoom${roomNumber}`;
       //         section.querySelector(`[id^="minusChildrenRoom"]`).id = `minusChildrenRoom${roomNumber}`;
       //         section.querySelector(`[id^="childrenRoom"]`).id = `childrenRoom${roomNumber}`;
       //         section.querySelector(`[id^="plusChildrenRoom"]`).id = `plusChildrenRoom${roomNumber}`;
       //     });
       // }
       ...
       const apiUrl = "https://staging.tradebloccorporatetravel.com/api/v2/locations";
       ...
       function submitFlightOW() {
           ...
           if (!from || !to || !date || !ppl) {
            ...
            function createSearchURL(params, passengers) {
                ...
                return `https://staging.tradebloccorporatetravel.com/flights/search?searchParams=${searchParams}`;
            }
    ...
    if (params.discount) {
        searchParams += `%2526disc_type%253D${encodeURIComponent(encodeURIComponent(params.discType))}%2526` +
            ...
            `disc_code%253D${encodeURIComponent(encodeURIComponent(params.discCode))}`;
                ...
                return `https://staging.tradebloccorporatetravel.com/cars/search?searchParams=${searchParams}`;
            }
       ...
       function searchCars(args) {
           ...
           fetch("https://staging.tradebloccorporatetravel.com/api/v2/car/availability", {
                   method: "POST",
                   headers: {
...
// Check if any field is empty
    if (!locNameHotel || !locIdHotel || !locCountryHotel || !checkin || !checkout || !room) {
        ...
        function createSearchURL(params) {
            ...
            return `https://staging.tradebloccorporatetravel.com/hotels/search?searchParams=${searchParams}`;
        }
...
function encodeQueryParams(params) {
    return Object.entries(params)
       ...
       const env = {
           apiUrl: "https://staging.tradebloccorporatetravel.com/api" // Replace this with the actual API base URL
       };
